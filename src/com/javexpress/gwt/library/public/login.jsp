...
<body class="login-layout light-login" style="background: none repeat scroll 0 0 #DFE0E2">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">jexpGwt</span>
								<span class="grey">Application</span>
							</h1>
							<h4 class="blue">&copy; javexpress.com</h4>
						</div>

						<div class="space-6"></div>

						<div class="position-relative">BURDAYIM
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter big">
											<i class="ace-icon fa fa-coffee green"></i>Lütfen Oturum Bilgilerinizi Giriniz
										</h4>
										...
										<fieldset>
											...
											<span class="block input-icon input-icon-right"> 
												<input type="text" class="form-control" placeholder="Kullanıcı" />
											...
											<div class="clearfix">
												<label class="inline">
													<input type="checkbox" class="ace"/><span class="lbl">Beni hatırla</span>
												</label>
	...
	<!--[if !IE]> -->
	<script src="ace/js/jquery.2.1.1.min.js"></script>
