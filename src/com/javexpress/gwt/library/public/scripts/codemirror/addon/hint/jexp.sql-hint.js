(function(mod) {
  ...
  function columnCompletion(result, editor) {
    ...
    if(!columns) {
    	//JES Start
    	var sqlHintLazyColumnProvider = editor.getOption("sqlHintLazyColumnProvider");
    	if (sqlHintLazyColumnProvider){
    		columns = sqlHintLazyColumnProvider.call(this, table);
    		if (columns)
  ...
  function findTableByAlias(alias, editor) {
    ...
    for(var i=0; i < query.length; i++){
      ...
      eachWord( lineText, function( word ){
        ...
        //JES if( wordUpperCase === aliasUpperCase && tables.hasOwnProperty( previousWord ) ){
