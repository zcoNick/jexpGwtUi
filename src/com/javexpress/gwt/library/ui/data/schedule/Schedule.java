...
import com.javexpress.gwt.fw.client.GwtApplication;
...
public class Schedule extends JexpWidget implements IDataChangeListener {
	...
	public Schedule(final Widget parent, final String id, final IJsonServicePoint servicePoint) {
		...
		this.dataUrl = GwtApplication.getModuleServiceTarget(servicePoint.getModuleId()).getServiceEntryPoint() + "." + ((Enum) servicePoint).toString();
